...
<body>
<div class="flex min-h-full items-start justify-center py-12 px-4 sm:px-6 lg:px-8">
  <div class="w-full max-w-md space-y-8">
    <div>
      <img class="mx-auto h-12 w-auto" src="{{asset('img/klogo1.png')}}" alt="Khairo Tech">
      <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Great Day to Start a Work</h2>
    ...
    <form class="mt-8 space-y-6" action="/sign-in" method="POST">
      ...
      @if($errors->any())
        <p class="text-center bg-red-200 rounded-md">{{$errors->first()}}</p>
      @else
